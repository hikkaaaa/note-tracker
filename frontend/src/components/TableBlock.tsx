    ...
    <div ref={containerRef} className="relative group/table w-full overflow-visible pb-5 pr-5 mt-2 transition-all">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 -right-3 flex flex-col gap-1 opacity-0 group-hover/table:opacity-100 transition-all z-10 print:hidden">
        <button 
          ...
          className="w-6 h-6 bg-white text-indigo-500 border border-slate-200 rounded-full flex items-center justify-center hover:scale-110 hover:bg-slate-50 shadow shadow-slate-200/50"
          title="Add Column"
        >
        ...
        <button 
          ...
          className="w-6 h-6 bg-white text-red-400 border border-slate-200 rounded-full flex items-center justify-center hover:scale-110 hover:bg-red-50 shadow shadow-slate-200/50"
          title="Delete Column"
        >
