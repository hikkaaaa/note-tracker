...
export function NoteTimer({
  ...
  return (
    <div
      className={`inline-flex select-none items-center gap-1.5 rounded-2xl border bg-white py-1.5 pl-3 pr-1.5 shadow-[0_8px_22px_-14px_rgba(27,19,38,0.3)] transition-shadow ${finished ? 'animate-pulse' : ''}`}
    ...
    >
      ...
      <button
        onClick={reset}
        aria-label="Reset"
        className="grid h-8 w-8 place-items-center rounded-xl text-[#6E5F7B] transition-colors hover:bg-[#1B1326]/[0.06] hover:text-[#1B1326]"
      >
