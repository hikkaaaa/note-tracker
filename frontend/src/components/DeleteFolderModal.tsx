    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-5 px-6 pb-6 pt-[22px]">
          <div className="flex items-center gap-3.5 rounded-2xl border border-[#1B1326]/[0.08] bg-[#1B1326]/[0.03] p-3.5">
            <span
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 truncate text-xs text-[#6E5F7B]">
          ...
          <p className="m-0 text-[13px] leading-relaxed text-[#6E5F7B]">
            Everything inside this folder will be moved to <b className="text-[#1B1326]">Trash</b>. You can restore it within 30 days.
          </p>
