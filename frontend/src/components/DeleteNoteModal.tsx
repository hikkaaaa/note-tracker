      ...
      >
        <div className="flex items-center justify-between border-b border-[#1B1326]/[0.07] px-6 pb-5 pt-[22px]">
          <div className="flex items-center gap-3.5">
            <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#DC2626]/10 text-[#DC2626]">
            ...
            <div>
              ...
              <p className="mt-1 text-[13px] text-[#6E5F7B]">This action can't be undone.</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-5 px-6 pb-6 pt-[22px]">
          <div className="flex items-center gap-3.5 overflow-hidden rounded-2xl border border-[#1B1326]/[0.08] bg-[#1B1326]/[0.03] p-3.5">
            <span className="h-11 w-[5px] flex-shrink-0 rounded-full" style={{ background: sw.swatch }} />
            <div className="min-w-0 flex-1">
              <div className="truncate text-base font-extrabold tracking-[-0.015em]" style={{ fontFamily: bricolage }}>
                {title}
              </div>
              <div className="mt-0.5 truncate text-xs text-[#6E5F7B]">{purpose || 'No purpose specified'}</div>
            </div>
          </div>

          <p className="m-0 text-[13px] leading-relaxed text-[#6E5F7B]">
            This note will be moved to <b className="text-[#1B1326]">Trash</b>. You can restore it within 30 days.
          </p>
